      ...
      <div class="container mainpadding">
        <div class="container">
          <div class="content">
            ...
            <p>
              Peas & Peppers respecteert de privacy van de bezoekers van haar website, in het bijzonder de rechten van bezoekers
              met betrekking tot de geautomatiseerde verwerking van persoonsgegevens. Vanwege volledige transparantie met
              onze klanten hebben wij daarom een beleid geformuleerd en geïmplementeerd met betrekking tot deze verwerkingen
              zelf, het doel ervan alsook de mogelijkheden voor betrokkenen om hun de rechten zo goed mogelijk te kunnen
              uitoefenen.
            </p>
            <p>
              Voor alle aanvullende informatie over de bescherming van persoonsgegevens kunt u terecht op de website van de <a href="https://autoriteitpersoonsgegevens.nl/nl" target="_blank">
            ...
            <ol type="1">
              <li> 
                Website (hierna ook “De website”): www.peasandpeppers.nl 
              </li>
              <li> 
                Verantwoordelijke voor de verwerking van persoonsgegevens (Hierna ook: “De beheerder”): Peas & Peppers ,
                gevestigd te Tesselseplein 19 , 2583 HP Den Haag , kvk-nummer: XXX 
              </li>
            </ol>
            <h2 class="title">
            ...
            <p>
              Uw gegevens worden verzameld door Peas & Peppers . Onder persoonsgegevens worden verstaan: alle informatie
              over een geïdentificeerde of identificeerbare natuurlijke persoon; als identificeerbaar wordt beschouwd een
              natuurlijke persoon die direct of indirect kan worden geïdentificeerd, met name aan de hand van een identificator
            ...
            <ul>
              ...
              <li>
                ...
                <p>
                  ...
                  onze websites bezoekt of vanaf welke pc het bezoek plaatsvindt.<br>
                  ...
                  en informatievoorziening beter afstemmen op de behoeften van bezoekers van onze website.<br>
              ...
              <li>
                ...
                <p>
                  - Google Analytics geanonimiseerd (analytische cookies)<br>
                  - Google Analytics (analytische cookie)<br>
                  - Adobe (analytische cookie)<br>
              ...
              <li>
                ...
                wij u uit om de volgende link te raadplegen: <a href="https://autoriteitpersoonsgegevens.nl/nl/onderwerpen/internet-telefoon-
                tv-en-post/cookies#faq" target="_blank">APG faq </a>
              </li>
            </ul>
